/**
 * Tela de Sign Up — redesenhada com novo design system dark
 */
...
export default function SignUpScreen() {
  ...
  async function handleSignUp() {
    ...
    try {
      ...
      // Nome será salvo no user store após o login via onboarding flow
      Alert.alert(
        "Conta criada!",
    ...
    >
      ...
      >
        ...
        <View style={s.footer}>
          ...
          <TouchableOpacity onPress={() => router.replace("/(auth)/sign-in")} disabled={isLoading}>
